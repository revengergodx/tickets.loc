                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('user.main.index') }}">Головна</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('user.ticket.index') }}">Tickets</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row justify-content-center mt-5">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form action="{{ route('user.comment.store', $ticket->id) }}" method="POST">
                                    @csrf
                                    <div class="row">
