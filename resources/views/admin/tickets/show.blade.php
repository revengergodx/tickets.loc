            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a href="{{ route('admin.ticket.edit', $ticket->id) }}" class="text-success"><i
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.ticket.index') }}">Пости</a></li>
                        ...
                        <div class="comments">
                            ...
                            <div class="row justify-content-center mt-5">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form action="{{ route('admin.comment.store', $ticket->id) }}" method="POST">
                                        @csrf
                                        <div class="row">
